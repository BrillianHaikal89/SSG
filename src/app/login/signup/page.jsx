...
export default function SignUpPage() {
  ...
  // Tambahkan state untuk mengontrol rendering di client-side
  ...
  // Handler form submission Step 1
  ...
  // Jika bukan client-side, kembalikan null
  if (!isClient) {
    return null;
  }
