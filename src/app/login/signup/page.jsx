...
function SignUpPage() {
  ...
  // New helper component for password fields with toggle visibility
  function renderPasswordField(id, label, value, onChange, placeholder, isVisible, setIsVisible, required = true) {
    const hasError = formSubmitted && formErrors[id];
          ...
          <div className="w-full max-w-md">
            ...
            {signupStep === 2 && (
              <form onSubmit={handleSignupStep2} className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {/* Replace standard password field with toggle-able password field */}
                  {renderPasswordField(
                    'passwordSignup', 
                    'Kata Sandi', 
                    passwordSignup, 
                  ...
                  {/* Replace standard confirm password field with toggle-able password field */}
                  {renderPasswordField(
                    'confirmPassword', 
