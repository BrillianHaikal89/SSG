...
export default function ECard() {
            ...
            <div class="print-container">
              <div class="card front">
                ...
                <div class="info-section">
                  <div style="display: flex; align-items: center; margin-bottom: 3mm;">
                    <img src="/img/logossg_white.png" alt="Logo" style="width: 8mm; height: 8mm; margin-right: 2mm;"/>
                    <div>
              ...
              <div class="card back">
                <div style="display: flex; justify-content: space-between; margin-bottom: 3mm;">
                  <img src="/img/logo_santri_siap_guna_full.png" alt="Logo" style="height: 10mm;"/>
                  <img src="/img/logo_DT_READY.png" alt="DT Logo" style="height: 8mm;"/>
                </div>
  ...
  // ... (kode untuk loading, error, dan null state tetap sama seperti sebelumnya)
